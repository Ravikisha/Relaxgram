            ...
            <div class="pt-4 grid sm:grid-cols-2 md:grid-cols-3 justify-center gap-4 border-top">
                ...
                @empty
                    <div class="flex flex-col col-span-3 items-center justify-center ">
                        <img src="{{ asset('img/noimage.png') }}" class="" alt="...">
                        <div class="card-body ">
                            <h1>No Posts Yet</h1>
                        </div>
                    </div>
            ...
            <div EditProfileContent
                ...
                <form method="POST" action="/profile/{{ $user->username }}" enctype="multipart/form-data">
                    ...
                    <div EditProfileBody class="h-[calc(100%_-_48px)]">
                        ...
                        <div class="form-group row ">
                            <label for="website" class="col-md-4 col-form-label text-md-right"><strong>
                                    {{ __('Website') }}</strong></label>

                            <div class="col-md-6">
                                <input id="website" type="text"
                                    class="form-control @error('website') is-invalid @enderror"
                                    name="website" value="{{ old('website') ?? $user->profile->website }}"
                        ...
                        <div class="form-group row ">
                            <label for="bio" class="col-md-4 col-form-label text-md-right"><strong>
                                    {{ __('Bio') }}</strong></label>

                            <div class="col-md-6">
                                <textarea name="bio" id="bio" class="form-control @error('bio') is-invalid @enderror" cols="30"
                                    rows="10" autocomplete="new-bio">{{ old('bio') ?? $user->profile->bio }}</textarea>
                                @error('bio')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <label for="image"
                                class="col-md-4 col-form-label text-md-right"><strong>Change
