                    ...
                    <div class="card mx-auto custom-card mb-5" id="prova">
                                ...
                                <div class="modal fade" id="post{{$post->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        <ul class="list-group">
                                            ...
                                            @can('delete', $post)
                                                <form action="{{url()->action('App\Http\Controllers\PostsController@destroy', $post->id)}}" method="POST">
                                                    @csrf
                                                    @method("DELETE")
                        ...
                        <div class="card-body px-3 py-2">
                            ...
                            <div class="d-flex flex-row">
                                <form method="POST" action="{{url()->action('App\Http\Controllers\LikeController@update2', ['like'=>$post->id])}}">
                                    @csrf
                                    @if (true)
